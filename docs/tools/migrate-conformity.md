...
### MS Teams Channel Fields

The tool prefers `channel_name` over `channel`:
- If both differ, a warning is generated
- Migration uses `channel_name` if present, falls back to `channel`
